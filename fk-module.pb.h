...
typedef enum _fk_module_QueryType {
    ...
    fk_module_QueryType_QUERY_BEGIN_TAKE_READINGS = 2,
    fk_module_QueryType_QUERY_READING_STATUS = 3
} fk_module_QueryType;
...
#define fk_module_WireMessageQuery_init_default  {(fk_module_QueryType)0, fk_module_QueryCapabilities_init_default, fk_module_BeginTakeReadings_init_default, fk_module_QueryReadingStatus_init_default}
...
#define fk_module_WireMessageQuery_init_zero     {(fk_module_QueryType)0, fk_module_QueryCapabilities_init_zero, fk_module_BeginTakeReadings_init_zero, fk_module_QueryReadingStatus_init_zero}
...
#define fk_module_WireMessageQuery_beginTakeReadings_tag 3
#define fk_module_WireMessageQuery_queryReadingStatus_tag 4
...
extern const pb_field_t fk_module_WireMessageQuery_fields[5];
...
#define fk_module_SensorReading_size             27
#define fk_module_WireMessageQuery_size          30
