...
typedef enum _fk_module_ReplyType {
    ...
    fk_module_ReplyType_REPLY_CAPABILITIES = 1,
    fk_module_ReplyType_REPLY_READING_STATUS = 2
} fk_module_ReplyType;
...
#define fk_module_WireMessageReply_init_default  {(fk_module_ReplyType)0, fk_module_Capabilities_init_default, fk_module_SensorCapabilities_init_default, fk_module_ReadingStatus_init_default, fk_module_SensorReadings_init_default}
...
#define fk_module_WireMessageReply_init_zero     {(fk_module_ReplyType)0, fk_module_Capabilities_init_zero, fk_module_SensorCapabilities_init_zero, fk_module_ReadingStatus_init_zero, fk_module_SensorReadings_init_zero}
...
#define fk_module_WireMessageReply_capabilities_tag 2
#define fk_module_WireMessageReply_sensorCapabilities_tag 3
#define fk_module_WireMessageReply_readingStatus_tag 4
#define fk_module_WireMessageReply_sensorReadings_tag 5
...
extern const pb_field_t fk_module_WireMessageReply_fields[6];
...
#define fk_module_WireMessageReply_size          (24 + fk_module_Capabilities_size + fk_module_SensorCapabilities_size + fk_module_SensorReadings_size)
