...
/* Generated by nanopb-0.3.9-dev at Thu Feb 15 16:34:25 2018. */
...
const pb_field_t fk_module_WireMessageQuery_fields[7] = {
...
const pb_field_t fk_module_WireMessageReply_fields[8] = {
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(fk_module_WireMessageQuery, queryCapabilities) < 65536 && pb_membersize(fk_module_WireMessageQuery, querySensorCapabilities) < 65536 && pb_membersize(fk_module_WireMessageQuery, beginTakeReadings) < 65536 && pb_membersize(fk_module_WireMessageQuery, queryReadingStatus) < 65536 && pb_membersize(fk_module_WireMessageQuery, custom) < 65536 && pb_membersize(fk_module_WireMessageReply, error) < 65536 && pb_membersize(fk_module_WireMessageReply, capabilities) < 65536 && pb_membersize(fk_module_WireMessageReply, sensorCapabilities) < 65536 && pb_membersize(fk_module_WireMessageReply, readingStatus) < 65536 && pb_membersize(fk_module_WireMessageReply, sensorReading) < 65536 && pb_membersize(fk_module_WireMessageReply, custom) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_fk_module_QueryCapabilities_fk_module_QuerySensorCapabilities_fk_module_Capabilities_fk_module_SensorCapabilities_fk_module_BeginTakeReadings_fk_module_QueryReadingStatus_fk_module_ReadingStatus_fk_module_SensorReadings_fk_module_SensorReading_fk_module_Custom_fk_module_WireMessageQuery_fk_module_Error_fk_module_WireMessageReply)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(fk_module_WireMessageQuery, queryCapabilities) < 256 && pb_membersize(fk_module_WireMessageQuery, querySensorCapabilities) < 256 && pb_membersize(fk_module_WireMessageQuery, beginTakeReadings) < 256 && pb_membersize(fk_module_WireMessageQuery, queryReadingStatus) < 256 && pb_membersize(fk_module_WireMessageQuery, custom) < 256 && pb_membersize(fk_module_WireMessageReply, error) < 256 && pb_membersize(fk_module_WireMessageReply, capabilities) < 256 && pb_membersize(fk_module_WireMessageReply, sensorCapabilities) < 256 && pb_membersize(fk_module_WireMessageReply, readingStatus) < 256 && pb_membersize(fk_module_WireMessageReply, sensorReading) < 256 && pb_membersize(fk_module_WireMessageReply, custom) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_fk_module_QueryCapabilities_fk_module_QuerySensorCapabilities_fk_module_Capabilities_fk_module_SensorCapabilities_fk_module_BeginTakeReadings_fk_module_QueryReadingStatus_fk_module_ReadingStatus_fk_module_SensorReadings_fk_module_SensorReading_fk_module_Custom_fk_module_WireMessageQuery_fk_module_Error_fk_module_WireMessageReply)
#endif
