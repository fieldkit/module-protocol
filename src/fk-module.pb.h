...
#define fk_module_Data_init_default              {0, {{NULL}, NULL}, 0, {{NULL}, NULL}}
...
#define fk_module_Data_init_zero                 {0, {{NULL}, NULL}, 0, {{NULL}, NULL}}
...
extern const pb_field_t fk_module_Data_fields[5];
