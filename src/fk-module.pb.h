...
#define _fk_module_QueryType_MAX fk_module_QueryType_QUERY_DATA_PREPARE
#define _fk_module_QueryType_ARRAYSIZE ((fk_module_QueryType)(fk_module_QueryType_QUERY_DATA_PREPARE+1))
...
#define fk_module_Data_init_default              {0, {{NULL}, NULL}, 0}
...
#define fk_module_Data_init_zero                 {0, {{NULL}, NULL}, 0}
...
extern const pb_field_t fk_module_Data_fields[4];
