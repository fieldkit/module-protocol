...
#define fk_module_Capabilities_init_default      {0, (fk_module_ModuleType)0, {{NULL}, NULL}, 0, fk_module_Firmware_init_default, 0, {{NULL}, NULL}, 0}
...
#define fk_module_Capabilities_init_zero         {0, (fk_module_ModuleType)0, {{NULL}, NULL}, 0, fk_module_Firmware_init_zero, 0, {{NULL}, NULL}, 0}
...
extern const pb_field_t fk_module_Firmware_fields[6];
extern const pb_field_t fk_module_Capabilities_fields[9];
extern const pb_field_t fk_module_FirmwareReply_fields[4];
...
extern const pb_field_t fk_module_WireMessageReply_fields[11];
...
#define fk_module_FirmwareReply_size             (18 + fk_module_Firmware_size + fk_module_Firmware_size + fk_module_Firmware_size)
...
#define fk_module_WireMessageReply_size          (107 + fk_module_Error_size + fk_module_Capabilities_size + fk_module_SensorCapabilities_size + fk_module_Custom_size + fk_module_Firmware_size + fk_module_Firmware_size + fk_module_Firmware_size)
