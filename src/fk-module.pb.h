...
#define fk_module_Capabilities_init_default      {0, _fk_module_ModuleType_MIN, {{NULL}, NULL}, 0, fk_module_Firmware_init_default, 0, {{NULL}, NULL}, 0, _fk_module_RequiredUptime_MIN}
...
#define fk_module_Capabilities_init_zero         {0, _fk_module_ModuleType_MIN, {{NULL}, NULL}, 0, fk_module_Firmware_init_zero, 0, {{NULL}, NULL}, 0, _fk_module_RequiredUptime_MIN}
...
extern const pb_field_t fk_module_Capabilities_fields[10];
