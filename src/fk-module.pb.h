...
#define _fk_module_QueryType_MAX fk_module_QueryType_QUERY_TRANSMISSION_STATUS
#define _fk_module_QueryType_ARRAYSIZE ((fk_module_QueryType)(fk_module_QueryType_QUERY_TRANSMISSION_STATUS+1))
...
#define _fk_module_ReplyType_MAX fk_module_ReplyType_REPLY_TRANSMISSION_STATUS
#define _fk_module_ReplyType_ARRAYSIZE ((fk_module_ReplyType)(fk_module_ReplyType_REPLY_TRANSMISSION_STATUS+1))
...
#define fk_module_Capabilities_init_default      {0, (fk_module_ModuleType)0, {{NULL}, NULL}, 0, fk_module_Firmware_init_default}
...
#define fk_module_Data_init_default              {0, {{NULL}, NULL}}
...
#define fk_module_Capabilities_init_zero         {0, (fk_module_ModuleType)0, {{NULL}, NULL}, 0, fk_module_Firmware_init_zero}
...
#define fk_module_Data_init_zero                 {0, {{NULL}, NULL}}
...
extern const pb_field_t fk_module_Capabilities_fields[6];
...
extern const pb_field_t fk_module_Data_fields[3];
